...
public class frmMainLogin extends javax.swing.JFrame {
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        u=new User(tenDN,matKhau);
        if (validation()) {
            try {
                boolean KiemTra = rmi.user.KiemTraDangNhap(u);
                if (KiemTra) {
                    JOptionPane.showMessageDialog(null, "Đăng nhập thành công", "Thông báo",JOptionPane.INFORMATION_MESSAGE);
                    new frmMain().setVisible(true);
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Sai tên đăng nhập or mật khẩu", "Thông báo",JOptionPane.WARNING_MESSAGE); 
                }
