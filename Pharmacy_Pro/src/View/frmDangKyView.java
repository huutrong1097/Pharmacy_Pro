...
public class frmDangKyView extends javax.swing.JFrame {

    public frmDangKyView() {
        initComponents();
    ...
    private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_okActionPerformed
        User model = new User(txt_tendangnhap.getText(), txt_tennguoidung.getText(), txt_matkhau.getText(), txt_diachi.getText(), txt_dienthoai.getText(), txt_quyen.getText());
        ClientControl cc=new ClientControl();
        cc.DangKy(model);
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_okActionPerformed
    public User setAllUser() {
        User model = new User(txt_tendangnhap.getText(), txt_tennguoidung.getText(), txt_matkhau.getText(), txt_diachi.getText(), txt_dienthoai.getText(), txt_quyen.getText());
        return model;
    }

    public void addHuyListener(ActionListener log) {
        btn_huy.addActionListener(log);
    }

    public void addOKListener(ActionListener log) {
        btn_ok.addActionListener(log);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDangKyView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
